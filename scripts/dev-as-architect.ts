...
const DESIGNS: Design[] = [
  {
    id: "pier-and-beam",
    prompt: "A pier-and-beam foundation: four 16×16-inch, 3-foot-tall piers at the corners of a 16' × 13' footprint, with a 16' × 13' × 8-inch slab sitting on top.",
...
`.trim(),
  ...
  {
    id: "silo-on-pad",
    prompt: "A 10-foot diameter, 20-foot-tall cylindrical silo standing on a 13' × 13' × 12-inch square concrete pad.",
...
`.trim(),
  ...
  {
    id: "wall-with-window",
    prompt: "A 20' × 10-inch × 10-foot wall with a 5-foot wide × 4-foot tall window centered horizontally, sill 3 feet off the floor.",
...
`.trim(),
  ...
  {
    id: "t-junction-wall",
    prompt: "Two walls meeting in a T-junction: a 20' × 8-inch × 10-foot wall along X, and a 13' × 8-inch × 10-foot wall along Y meeting it at the midpoint.",
...
`.trim(),
  ...
  {
    id: "hollow-box",
    prompt: "A hollow box, outer dimensions 10' × 6' × 8', with 6-inch wall thickness on all six faces (a closed shell).",
...
`.trim(),
...

  {
    ...
    prompt: "A 13' × 10' × 8' box with a triangular pitched roof on top (4-foot ridge height, gable runs along the X axis).",
...
`.trim(),
  ...
  {
    id: "octagonal-column",
    prompt: "An octagonal column, 20-inch circumradius, 13-foot tall, on a 3' × 3' × 8-inch square footing.",
...
`.trim(),
...

  {
    ...
    prompt: "A cylindrical tank of 4-foot inner radius, 4-inch wall thickness, 10-foot tall, generated by revolving a rectangular wall profile around the vertical axis.",
